...
// Variables
const rootDomain = "febriganteng.us.kg"; // Ganti dengan domain utama kalian
const serviceName = "cf-ganteng"; // Ganti dengan nama workers kalian
const apiKey = "Y7x23pxmiV7Xg0TcnXktGb_Tn8KrBqpyakDtKUcx"; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
const apiEmail = "miftahulfebri36@gmail.com"; // Ganti dengan email yang kalian gunakan
const accountID = "819de5d9251200b181216bcc20d0e7a6"; // Ganti dengan Account ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
const zoneID = "e597e61b8c5f1ec6c4df9af557765020"; // Ganti dengan Zone ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
...
function getAllConfig(request, hostName, proxyList, page = 0) {
  ...
  try {
    ...
    document.setTitle("Welcome to <span class='text-blue-500 font-semibold'>Febri Ganteng Bro</span>");
